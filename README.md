					...
					<section id="two" class="wrapper style3">
						<section class="spotlight">
							...
							<div class="image"><img src="gaya.jpg" alt="" /></div><div class="content">
                                                        <p>I am a BSc Mathematics graduate who has recently completed an MSc in Computational Biology with a specialization in Machine Learning. My academic journey has equipped me with a strong mathematical foundation, which I've seamlessly integrated with cutting-edge machine learning techniques to explore the complexities of biological systems. I'm now eager to apply my skills and knowledge to real-world challenges in computational biology, with a passion for advancing research and technology in this interdisciplinary field.</p>
							</div>
